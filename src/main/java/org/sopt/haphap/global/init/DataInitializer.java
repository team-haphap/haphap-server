...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        seed("자율주행개발 - 2026 3월 신입 채용", "남양, 판교", dev, hyundai,
                stage("서류", 1, d(2026, 5, 22), 87),
                stage("인적성검사", 2, d(2026, 6, 5), 23),
                stage("직무면접", 3, d(2026, 6, 19), 44),
                stage("임원면접 (최종)", 4, d(2026, 7, 17), 65));   // 오늘 → 미발표

        seed("차량개발 - 2026 3월 신입 채용", "남양", dev, hyundai,
                stage("서류", 1, d(2026, 5, 22), 34),
                stage("인적성검사", 2, d(2026, 6, 5), 80),
                stage("직무면접", 3, d(2026, 6, 16), 23),           // 시트 0.234
                stage("임원면접 (최종)", 4, d(2026, 7, 30), 65));   // 미래 → 미발표

        seed("경영기획 - 2026 3월 신입 채용", "양재", pm, hyundai,
                stage("서류", 1, d(2026, 5, 22), 66),
                stage("인적성검사", 2, d(2026, 6, 5), 23),
                stage("직무면접", 3, d(2026, 6, 19), 19),
                stage("임원면접 (최종)", 4, d(2026, 6, 30), 70));

        seed("신사업 전략 기획 - 2026 3월 신입 채용", "양재", pm, hyundai,
                stage("서류", 1, d(2026, 5, 22), 86),
                stage("인적성검사", 2, d(2026, 6, 5), 58),
                stage("직무면접", 3, d(2026, 6, 19), 34),
                stage("임원면접 (최종)", 4, d(2026, 6, 30), 91));

        seed("HR - 2026 3월 신입 채용", "양재, 울산", hr, hyundai,
                stage("서류", 1, d(2026, 5, 22), 10),
                stage("인적성검사", 2, d(2026, 6, 5), 45),
                stage("직무면접", 3, d(2026, 6, 19), 76),
                stage("임원면접 (최종)", 4, d(2026, 6, 30), 34));

        // ===== 네이버 / 카카오 / 아모레 (기존) =====
        seed("Product Design - 2025 신입 공채", "NAVER 1784", design, naver,   // 공고명 "2025" → 2025
        ...
        seed("2025년 하반기 신입사원 채용 (마케팅 / 영업)", "종로구", sales, lgHnh,  // 공고명 "2025년" → 2025
        ...
        seed("ML Data Assistant 신입 채용", "강남", dev, toss,  // 전부 미래
                stage("서류 전형", 1, d(2026, 8, 11), 56),
                stage("직무 인터뷰", 2, d(2026, 8, 17), 45),
                stage("문화적합성 인터뷰 (최종)", 3, d(2026, 8, 28), 63));
        ...
        seed("이용자보호 업무 신입 채용", "판교 오피스", dev, kakao,  // 1~2번 발표 / 3~4번 미발표
                stage("지원서 접수", 1, d(2026, 7, 7), 44),
                stage("직무 적합성 평가", 2, d(2026, 7, 15), 64),
                stage("직무 적성 검사", 3, d(2026, 7, 24), 21),
                stage("면접 (최종)", 4, d(2026, 7, 30), 34));
        ...
        seed("려BM팀 디자이너 신입 채용", "용산구", design, amore,  // 1~2번 발표 / 3번 미발표
        ...
        seed("디지털컨텐츠 제작 신입 채용", "용산구", pm, amore,
                stage("서류 전형", 1, d(2026, 6, 4), 34),
                stage("1차 면접", 2, d(2026, 6, 12), 21),
                stage("2차 면접 (최종)", 3, d(2026, 6, 20), 65));
        ...
        seed("AX 신입 채용", "화성", dev, lgHnh,  // 전부 미래
                stage("서류 접수", 1, d(2026, 10, 11), 43),
                stage("인성 검사", 2, d(2026, 10, 17), 24),
                stage("1차 면접", 3, d(2026, 10, 27), 15),
                stage("2차 면접 (최종)", 4, d(2026, 11, 6), 62));
        ...
        seed("디지털컨텐츠 소셜크루 신입 채용", "화성", design, lgHnh,
                stage("서류 전형", 1, d(2026, 4, 5), 26),
                stage("면접 (최종)", 2, d(2026, 4, 11), 47));
